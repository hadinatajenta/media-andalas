<!-- Footer Start -->
    <div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-5">
        <div class="row py-4">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p class="font-weight-medium"><i class="fa fa-map-marker-alt mr-2"></i>{{$websiteInfo->alamat}}</p>
                <p class="font-weight-medium"><i class="fa fa-phone-alt mr-2"></i>{{$websiteInfo->no_telp}}</p>
                <p class="font-weight-medium"><i class="fa fa-envelope mr-2"></i>{{$websiteInfo->email}}</p>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="m-n1">
                    @foreach ($categories as $item) 
                        <a href="" class="btn btn-sm btn-secondary m-1">{{$item->nama_kategori}}</a>
                    @endforeach
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5" style="background: #111111;">
        <p class="m-0 text-center">&copy; <a href="#">{{$websiteInfo->nama_website}}</a>. All Rights Reserved. 
