        ...
        <div class="row" style="border-radius: 20px;">
            ...
            <div class="col-md-4 p-2" style="background-color: white; color:#24252a; border-right:1px solid #eaeaea">
                <div class="btn p-2 w-100" style="background-color:#e9f0ff; border:1px solid #eaeaea">
                    <a href="/admin/pengaturan/profile" class=" d-flex my-1" style="color:#2c72fe; text-decoration:none;"><i class='bx bxs-edit bx-sm'></i> &nbsp; Edit profile</a>
            ...
            <div class="col-md-8 p-2" style="background-color: white; color:#24252a;" >
                ...
                <form class="p-2" action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if (session('success'))
